...
import guru.springframework.hl7.transformers.v22.HL7v22Parser;
...
public class HL7ParserTest {
    ...
    private static final String MSG = "MSH|^~\\&|HIS|RIH|EKG|EKG|199904140038||ADT^A01||P|2.2\r"
    ...
    private HL7v22Parser parser;

    @Before
    public void setUp() throws Exception {

        parser = new HL7v22Parser();
    }
