...
public class HL7v25MessageServiceImplTest {

    final String HL7V25MSG = "MSH|^~\\&|HIS|RIH|EKG|EKG|199904140038||ADT^A01||P|2.5\r"
    ...
    private HL7MessagePublisher hl7MessagePublisher;
    ...
    @Autowired
    @Qualifier("HL7v25MessagePublisherImpl")
    public void setHl7MessagePublisher(HL7MessagePublisher hl7MessagePublisher)
    {
        this.hl7MessagePublisher = hl7MessagePublisher;
    }

    @Test
    public void testMessageSend() throws Exception
    {
        hl7MessagePublisher.sendHL7Message(HL7V25MSG);
        Thread.sleep(3000);
