...
public class HL7v24MessageServiceImplTest {

    final String HL7V24MSG = "MSH|^~\\&|HIS|RIH|EKG|EKG|199904140038||ADT^A01||P|2.4\r"
    ...
    @Autowired
    @Qualifier("HL7v24MessagePublisherImpl")
    ...
    {
        hl7MessagePublisher.sendHL7Message(HL7V24MSG);
        Thread.sleep(3000);
